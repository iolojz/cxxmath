...
BOOST_AUTO_TEST_CASE( test_product_monoid_int_int ) {
	...
	using addition_monoid = typename default_group_t<int>::monoid_;
	using multiplication_monoid = default_monoid_t<int>;
	
	using mult_int_int_monoid = product_monoid<std_pair_product, multiplication_monoid, multiplication_monoid>;
	using mixed_int_int_monoid = product_monoid<std_pair_product, addition_monoid, multiplication_monoid>;
	
	auto pair0_1 = make_product<std_pair_product>( 0, 1 );
	auto pair1_1 = make_product<std_pair_product>( 1, 1 );
	auto pair42_23 = make<std_pair_tag>( 42, 23 );
	auto pair1764_529 = make_pair( 42 * 42, 23 * 23 );
	auto pair84_529 = make_pair( 42 + 42, 23 * 23 );
	
	auto pair = pair42_23;
	
	BOOST_TEST( mult_int_int_monoid::compose( pair42_23, pair42_23 ) == pair1764_529 );
	BOOST_TEST( mult_int_int_monoid::neutral_element() == pair1_1 );
	BOOST_TEST( mult_int_int_monoid::is_abelian_monoid() == true );
	BOOST_TEST( mult_int_int_monoid::compose_assign( pair, pair ) == pair1764_529 );
...
BOOST_AUTO_TEST_CASE( test_product_monoid_int_vector ) {
	...
	using int_vector_monoid = product_monoid<
		std_pair_product,
		default_monoid_t<int>,
		default_monoid_t<tag_of_t<string_vector>>
	>;
	...
	auto pair1_empty = make_pair( 1, empty );
	auto pair42_a = make_pair( 42, a );
	auto pair1764_aa = make_pair( 42 * 42, aa );

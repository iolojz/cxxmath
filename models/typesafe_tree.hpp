...
template<class NodeDataTypes, class Arities> class typesafe_tree {
	...
	static constexpr auto arity_map = boost::hana::make_map( boost::hana::zip(
		node_data_types,
		arities
	) );
...
public:
	template<class NodeData>
	static constexpr auto arity( boost::hana::basic_type<NodeData> ) {
		return boost::hana::at_key( arity_map, boost::hana::type_c<NodeData> );
	}
	
	template<class NodeData>
	static constexpr bool is_terminal( boost::hana::basic_type<NodeData> ) {
	...
	template<class NodeData>
	constexpr bool holds_node( boost::hana::type_c<NodeData> ) {

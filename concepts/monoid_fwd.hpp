...
template<class Compose, class NeutralElement, class IsAbelian> using non_assignable_monoid = monoid<
	impl::unsupported_implementation, Compose, NeutralElement, IsAbelian
>;

template<class ComposeAssign, class NeutralElement, class IsAbelian> using assignable_monoid = monoid<
	ComposeAssign, impl::binary_operator<ComposeAssign, IsAbelian>, NeutralElement, IsAbelian
>;
